...
$tpl->set ( '{multilanguage}', dle_ml_front_switcher_markup() );
...
if( isset($config['http_home_url_lang']) AND $config['http_home_url_lang'] ) {
	$config['http_home_url'] = $config['http_home_url_lang'];
} else {
