...
dle_ml_prepare_home_url($config);
...
dle_ml_maybe_redirect_legacy_public($config);
...
dle_ml_localize_categories($cat_info, isset($config['active_language']) ? $config['active_language'] : '');
...
$selected_site_language = isset($config['active_language']) ? $config['active_language'] : dle_ml_main_folder($config);
dle_ml_load_website_lang($selected_site_language);

$config['home_title'] = dle_ml_get_setting_value('home_title', $selected_site_language, $config['home_title']);
$config['short_title'] = dle_ml_get_setting_value('short_title', $selected_site_language, $config['short_title']);
...
$tpl->set( '{registration-link}', dle_ml_public_url('register', array(), $config) );
$tpl->set( '{lostpassword-link}', dle_ml_public_url('lostpassword', array(), $config) );
