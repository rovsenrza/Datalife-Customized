...
if ($_GET['action'] == "disable") {
	...
	@unlink(ENGINE_DIR . '/cache/system/metatags.json');
...
if ($_POST['action'] == "add") {
	...
	$page_title  = $db->safesql(  htmlspecialchars( strip_tags( stripslashes($_POST['page_title'] ) ), ENT_QUOTES, 'UTF-8') );
	$page_description = $db->safesql( $parse->BB_Parse( $parse->process( $_POST['page_description'] ), false ) );
	$robots  = $db->safesql(  htmlspecialchars( strip_tags( stripslashes($_POST['robots'] ) ), ENT_QUOTES, 'UTF-8') );
...
$(function(){
		...
		$('.dellink').click(function(){
		    ...
		    DLEconfirmDelete( '{$lang['redirects_del']} <b>&laquo;'+old_link+'&raquo;</b>', '{$lang['p_confirm']}', function () {
