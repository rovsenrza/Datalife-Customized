...
if (isset( $_REQUEST['searchword'] ) AND $_REQUEST['searchword']) {
  ...
  $searchword = htmlspecialchars( strip_tags( stripslashes( trim( urldecode ( $_REQUEST['searchword'] ) ) ) ), ENT_COMPAT, 'UTF-8' );
...
if ($_GET['action'] == "add") {
	...
	$tag = @$db->safesql( htmlspecialchars( strip_tags( stripslashes( trim( urldecode ( $_GET['tag'] ) ) ) ), ENT_COMPAT, 'UTF-8' ) );
	$title = @$db->safesql( htmlspecialchars( strip_tags( stripslashes( trim( urldecode ($_GET['title'] ) ) ) ), ENT_QUOTES, 'UTF-8' ) );
	$url = @$db->safesql( htmlspecialchars( strip_tags( stripslashes( trim( $_GET['url'] ) ) ), ENT_QUOTES, 'UTF-8' ) );
...
<!--
	...
	function addLink() {
		...
		$("body").append("<div id='dlepopup' title='{$lang['add_links_new']}' style='display:none'>{$lang['add_links_tag']}<br><input type='text' dir='auto' name='dle-promt-tag' id='dle-promt-tag' class='classic' style='width:100%;' value=''><br><br>{$lang['add_links_url']}<br><input type='text' dir='auto' name='dle-promt-url' id='dle-promt-url' class='classic' style='width:100%;' value='http://'><br><br>{$lang['bb_url_tooltip']}<br><input type='text' dir='auto' name='dle-promt-title' id='dle-promt-title' class='classic' style='width:100%;' value=''><br><br>{$lang['links_rcount']} <input type='text' dir='auto' name='dle-rcount' id='dle-rcount' class='classic' style='width:50px;' value='0'/> {$lang['links_rcount_1']}<br /><br />{$lang['links_area_1']} <select name='replacearea' id='replacearea' class='dropup uniform' data-dropup-auto='false'><option value='1'>{$lang['links_area_2']}</option><option value='2'>{$lang['links_area_3']}</option><option value='3'>{$lang['links_area_4']}</option><option value='4'>{$lang['links_area_5']}</option><option value='5'>{$lang['links_area_8']}</option><option value='6'>{$lang['links_area_9']}</option></select><br><br><label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='only-one' id='only-one' value=''>{$lang['add_links_one']}</label>&nbsp;&nbsp;&nbsp;<label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='targetblank' id='targetblank' value=''>{$lang['links_target']}</label></div>");
		
		$('#dlepopup .uniform').selectpicker();
		
		$("#dlepopup .icheck").uniform({
			radioClass: 'choice',
			wrapperClass: 'border-teal-600 text-teal-800',
			fileButtonClass: 'btn bg-teal btn-sm btn-raised'
		});

		$('#dlepopup select.uniform').on('hide.bs.select', function () {
		
			setTimeout(function() {
				$('#dlepopup .btn-group.bootstrap-select.uniform').addClass('dropup');
			}, 10);
...
$(function(){
		...
		$('.dellink').click(function(){
		    ...
		    DLEconfirmDelete( '{$lang['tagscloud_del']} &laquo;'+tag_name+'&raquo; {$lang['tagscloud_del_2']}', '{$lang['p_confirm']}', function () {
		...
		$('.editlink').click(function(){
			...
			$("body").append("<div id='dlepopup' title='{$lang['add_links_new']}' style='display:none'>{$lang['add_links_tag']}<br><input type='text' dir='auto' name='dle-promt-tag' id='dle-promt-tag' class='classic' style='width:100%;' value=\""+tag+"\"/><br><br>{$lang['add_links_url']}<br><input type='text' dir='auto' name='dle-promt-url' id='dle-promt-url' class='classic' style='width:100%;' value='"+url+"'><br><br>{$lang['bb_url_tooltip']}<br><input type='text' dir='auto' name='dle-promt-title' id='dle-promt-title' class='classic' style='width:100%;' value='"+title+"'><br><br>{$lang['links_rcount']} <input type='text' dir='auto' name='dle-rcount' id='dle-rcount' class='classic' style='width:50px;' value='"+rcount+"'> {$lang['links_rcount_1']}<br><br>{$lang['links_area_1']} <select name='replacearea' id='replacearea' class='dropup uniform' data-dropup-auto='false'><option value='1'>{$lang['links_area_2']}</option><option value='2'>{$lang['links_area_3']}</option><option value='3'>{$lang['links_area_4']}</option><option value='4'>{$lang['links_area_5']}</option><option value='5'>{$lang['links_area_8']}</option><option value='6'>{$lang['links_area_9']}</option></select><br><br><label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='only-one' id='only-one' value=''>{$lang['add_links_one']}</label>&nbsp;&nbsp;&nbsp;<label class='checkbox-inline margin-left'><input type='checkbox' class='icheck' name='targetblank' id='targetblank' value=''>{$lang['links_target']}</label><input type='hidden' name='url-id' id='url-id' value='"+urlid+"'></div>");
