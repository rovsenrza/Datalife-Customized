...
<div class="tab-pane" id="tabml_{$ml_code_safe}">
	<div class="form-group">
	  ...
	  <div class="col-sm-10">
		<input type="text" dir="auto" class="form-control width-550" name="translations[{$ml_folder_safe}][title]" maxlength="250">
	  </div>
	 </div>
	 <div class="form-group editor-group">
	  <label class="control-label col-md-2">{$lang['addnews_short']}</label>
	  <div class="col-md-10">
		<div class="editor-panel"><textarea id="ml_short_story_{$ml_code_safe}" name="translations[{$ml_folder_safe}][short_story]" class="wysiwygeditor" style="width:98%;height:300px;"></textarea></div>
	  </div>
	 </div>
	 <div class="form-group editor-group">
	  <label class="control-label col-md-2">{$lang['addnews_full']}</label>
	  <div class="col-md-10">
		<div class="editor-panel"><textarea id="ml_full_story_{$ml_code_safe}" name="translations[{$ml_folder_safe}][full_story]" class="wysiwygeditor" style="width:98%;height:300px;"></textarea></div>
	  </div>
	 </div>
	 <div class="form-group">
	  <label class="control-label col-md-2 col-sm-3">{$lang['addnews_tags']}</label>
	  <div class="col-md-10 col-sm-9">
		<input type="text" dir="auto" name="translations[{$ml_folder_safe}][tags]" class="form-control width-500">
	  </div>
	 </div>
	 <div class="form-group">
	  <label class="control-label col-md-2 col-sm-3">{$lang['meta_title']}</label>
	  <div class="col-md-10 col-sm-9">
		<input type="text" dir="auto" name="translations[{$ml_folder_safe}][metatitle]" class="form-control width-500" maxlength="140">
	  </div>
	 </div>
	 <div class="form-group">
	  <label class="control-label col-md-2 col-sm-3">{$lang['meta_descr']}</label>
	  <div class="col-md-10 col-sm-9">
		<input type="text" dir="auto" name="translations[{$ml_folder_safe}][descr]" id="ml_autodescr_{$ml_code_safe}" class="form-control width-500" maxlength="300">
	  </div>
	 </div>
	 <div class="form-group">
	  <label class="control-label col-md-2 col-sm-3">{$lang['meta_keys']}</label>
	  <div class="col-md-10 col-sm-9">
		<textarea dir="auto" class="tags ml-keywords" name="translations[{$ml_folder_safe}][keywords]" id="ml_keywords_{$ml_code_safe}"></textarea><br><br>
...
elseif( $action == "doaddnews" ) {
	...
	dle_ml_save_post_translation($id, $ml_main_folder, array(
		'title' => $title_main,
	...
	foreach ($ml_languages as $ml_folder => $ml_meta) {
		...
		dle_ml_save_post_translation($id, $ml_folder, array(
			'title' => $ml_title,
