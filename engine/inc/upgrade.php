...
if($_REQUEST['action'] == "upgrade_files" ) {
		...
		try {
			...
			if( isset($_SESSION['distr']['ftp']) AND $_SESSION['distr']['ftp'] )	{
...
HTML;
	...
	if ( !isset($_SESSION['db_upgrade']) OR !$_SESSION['db_upgrade'] )	{
...
HTML;
	...
	if ( !isset($_SESSION['db_convert']) OR !$_SESSION['db_convert'] )	{
