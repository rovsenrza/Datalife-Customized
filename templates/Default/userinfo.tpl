				...
				<div id="options">
					<div class="addform">
						<ul class="ui-form">
							...
							<li class="form-group form-sep"></li>
							<li class="form-group">
								<label>Two-factor authorization</label>
								{twofactor-auth}
							</li>
							<li class="form-group form-sep"></li>
							<li class="form-group">
							...
							<li class="form-group">
								<div class="checkbox"><label class="form-check-label"><input class="form-check-input" type="checkbox" name="del_foto" id="del_foto" value="yes"><span>Remove avatar</span></label></div>
							</li>
							<li class="form-group form-sep"></li>
							<li class="form-group">
						...
						<div class="form_submit">
							<button class="btn btn-big" name="submit" type="submit"><b>Save</b></button> [delete]<b>Delete Account</b>[/delete]
