...
<body>
	...
	<div class="page[available=showfull] showfull[/available]">
		<div class="wrp">
			...
			<header id="header">
				<!-- Search -->
				<form id="q_search" class="rightside" action="/search/" method="get">
					<div class="q_search">
						<input id="story" name="story" placeholder="Search..." type="search">
						<button class="btn q_search_btn" type="submit" title="Find"><svg class="icon icon-search"><use xlink:href="#icon-search"></use></svg><span class="title_hide">Find</span></button>
						<a class="q_search_adv" href="/search/advanced/" title="Extended Search"><svg class="icon icon-set"><use xlink:href="#icon-set"></use></svg><span class="title_hide">Extended Search</span></a>
					</div>
