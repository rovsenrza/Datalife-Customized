		...
		<div class="addform">
			<ul class="ui-form">
				...
				<li class="form-group addvote" style="display:none;">
					...
					<textarea name="vote_body" rows="5" class="wide" placeholder="Each new line is one of the answer choices">{votebody}</textarea><br><label class="form-check-label"><input class="form-check-input" type="checkbox" name="allow_m_vote" value="1" {allowmvote}><span>Allow multiple choice</span></label>
				</li>
				[allow-shortstory]
				<li class="form-group">
